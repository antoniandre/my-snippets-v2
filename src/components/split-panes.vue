    ...
    onMouseMove (e) {
      if (this.touch.mouseDown) {
        ...
        if (this.horizontal) {
          ...
          console.log('mouse Move', dragPercentage, this.touch.sumOfWidths)
        }
      }
    },
...
.split-panes {
  ...
  &--vertical > .split-panes__splitter {width: 10px;cursor: ew-resize;}
  &--horizontal > .split-panes__splitter {height: 10px;cursor: ns-resize;}
}
</style>
